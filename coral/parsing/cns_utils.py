...
from coral.parsing import cns_types
from coral.parsing.cns_types import RawCNInterval
...
class CNSegIntervals:
    ...
    def get_cn_intervals(self, chr_tag: str, pos: int) -> set[cns_types.CnsInterval]:
        """Get the CN segment intervals for a given position"""
        return self.tree[chr_tag][pos]

    def get_cn_interval(self, chr_tag: str, pos: int) -> cns_types.CnsInterval:
