...
def maximize_weights_greedy(
    ...
    # cycles: list[Any] = [[], []]  # cycles, paths
    # cycle_weights: list[Any] = [[], []]  # cycles, paths
    # path_constraints_satisfied: list[Any] = [[], []]  # cycles, paths

    lp_solution = datatypes.ParsedLPSolution()
    ...
    while next_w >= resolution and (
        ...
        next_w = lp_solution.walk_weights[0][0]
        ...
        while k <= nedges:
            if (
                ...
                if postprocess == 1:
                    ...
                    bb.cycles[amplicon_idx] = lp_solution.walks
                    bb.cycle_weights[amplicon_idx] = lp_solution.walk_weights
